...
import { generateInterviewQuestions } from '../../services/interviewQuestionService.ts';
...
const InterviewQuestionGenerator: React.FC<InterviewQuestionGeneratorProps> = ({
  ...
  return (
    <div className="bg-slate-800/90 border border-slate-700 rounded-2xl shadow-2xl max-w-4xl mx-auto">
      {/* Header */}
      <div className="p-6 border-b border-slate-700 bg-gradient-to-r from-purple-900/20 to-blue-900/20">
          ...
          <div className="mb-6 bg-slate-800/50 rounded-xl p-4">
            ...
            <div className="flex flex-wrap gap-2">
              {selectedCandidates.map(candidate => (
                <span key={candidate.id} className="bg-orange-900/30 text-orange-300 px-3 py-1 rounded-full text-sm">
